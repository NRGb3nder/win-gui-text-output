...
TextTable::TextTable(HDC hDc, TableContent &content, int x, int y, int wdthTable,
    HFONT hFont, bool bAlignRows, int hghtEmptyTable) : m_hDc(hDc), m_content(content), m_x(x), m_y(y), m_wdthTable(wdthTable),
